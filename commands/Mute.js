...
if (!üye) return message.channel.send(embed.setDescription("Geçerli bir kullanıcı belirtmelisin! [`!mute @ReawenID 5m Düzeni Bozma`]"));
...
if (!süre || !ms(süre)) return message.channel.send(embed.setDescription("Geçerli bir süre belirtmelisin! [`!mute @ReawenID 5m Düzeni Bozma`]"));
